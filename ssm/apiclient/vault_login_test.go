...
func TestLoginVaultAppRoleSuccess(t *testing.T) {
	...
	factory.UdmConfig = factory.Config{Configuration: &factory.Configuration{Vault: &factory.Vault{VaultUri: server.URL, TLS_Insecure: true}}}
...
func TestLoginVaultPrefersK8s(t *testing.T) {
	...
	factory.UdmConfig = factory.Config{Configuration: &factory.Configuration{Vault: &factory.Vault{
		VaultUri:     server.URL,
		TLS_Insecure: true,
		K8sRole:      "role",
